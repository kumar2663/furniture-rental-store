...
('WorkStation', 'CHAIRS', '1800', '500', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRDtYL5ud1ttqPNPBO_f9Oiy3Ak9vfJEIOG4A&usqp=CAU', '5', '0', 'office chairs, fabric back, customised height', NULL),
...
('Outdoor', 'BARBEQUE GRILL', '1000', '150', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ-4oT8H7egFGirL7_uWuEJJWc-_Dr7hTWvNg&usqp=CAU', '5', '0', 'stain less steel, 4 kg weight, manual assembly required', NULL),
...
('Outdoor', 'HAMMOCK', '1800', '420', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQgtqcyr7fnZ0fdQqg2KCZOb5xDm6HyhaCPrTGUWmeDdgDiB0N-idptyS9-BrGvrJPLjtY&usqp=CAU', '5', '0', 'Iron base, rubber wood, no assembly required', NULL),
...
('Outdoor', 'WOODEN PATIO', '2500', '750', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSPBWT5iVEbxh0Rq0MTQpr7yFTT4bbuhdxttQ&usqp=CAU', '5', '0', '4 seater, walnut brown colour', NULL),
...
('HomeDecor', 'BOOK SHELF', '3500', '1500', 'https://www.woohome.com/wp-content/uploads/2013/11/Genius-home-decor-ideas-9-2.jpg', '5', '0', 'white plywood, carpenter assembly required', NULL),
...
('BedRoom', 'BED', '15000', '2500', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS-5430RezamgAqxD0-tIBIZYMaR4h0l2kZ2Q&usqp=CAU', '5', '0', 'Queen Size bed , engineering wood, carpenter assembly, no storage.', '19CS!0038-good product/'),
...
('BedRoom', 'DRESSING TABLE', '7000', '1200', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTQsXczqvzWGNgP5-K3qpMx3epcqeV1mLzsXQ&usqp=CAU', '5', '0', 'Carpenter assembly, engineering wood', NULL),
...
CREATE TABLE `MyUsers` (
  ...
  `intrest` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `MyUsers` (`username`, `user_pass`, `email`, `Address`, `Delivery_info`, `phone_number`, `renting_cart`, `prev_order`, `intrest`, `cart_price`, `return_cart`, `dummy`, `additional`) VALUES
('vijay 6326', 'Kvijay@26', 'kapalavayiv@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, '306', NULL, NULL, NULL);
